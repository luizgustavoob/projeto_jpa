...
public class ProdutoDao {
	...
	public List<Produto> getProdutosComCategoria(){
		return em
				.createQuery("from Produto p join fetch p.categorias", Produto.class)
				.getResultList();
	}
	...
	public List<Produto> getProdutos(String nome, Integer categoriaId, Integer lojaId) {
		...
		Root<Produto> root = query.from(Produto.class); //Basicamente, o "from" da consulta.
